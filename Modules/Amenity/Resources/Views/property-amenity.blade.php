        ...
        <div class="card-header bg-gradient text-white d-flex justify-content-between align-items-center"
            ...
            <div>
                <button class="btn btn-add-admin" data-bs-toggle="modal" data-bs-target="#addAmenityModal">
                    <i class="bi bi-plus-lg me-1"></i> Add Extra Amenity
                </button>
...
<div class="modal fade" id="addAmenityModal" tabindex="-1" aria-labelledby="addAmenityModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content shadow border-0 rounded-4 overflow-hidden">
      ...
      <!-- Form Start -->
      <form action="{{ route('property.amenities.add', $property->slug) }}" method="POST" enctype="multipart/form-data">
        @csrf
          ...
          <div class="row g-4">
            ...
            <div class="col-md-12">
              ...
              <div class="input-group">
                ...
                <select name="amenities[]" id="" class="form-control shadow-sm rounded-end rounded-pill @error('amenities') is-invalid @enderror" multiple>
        ...
        <div class="modal-footer bg-light d-flex justify-content-between rounded-bottom-4 px-4 py-3">
          ...
          <button type="submit" class="btn btn-primary rounded-pill px-4">
            <i class="bi bi-check-circle me-1"></i> Add Amenity
          </button>
        </div>
      </form>
    ...
    <script>
        $(document).ready(function () {
            $('#property-amenities-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route("property.amenities", $property->slug) }}',
                columns: [
                    { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false },
                    { data: 'amenity_info', name: 'name' },
