...
<div class="container py-4" style="max-width: 540px;">
    ...
    <div class="d-flex align-items-center mb-4">
        <a href="{{ route('property.details', $property->slug) }}" class="text-dark me-3"><i class="bi bi-arrow-left fs-5"></i></a>
    ...
    <form action="{{ route('phonepe.initiate', $property->slug) }}" method="POST">
        @csrf
        <!-- Input Details -->
        <div class="bg-white p-3 mb-3 rounded-4 border">
            ...
            <div class="d-flex gap-3 mb-4">
                <div class="flex-fill">
                    ...
                    <input type="date" class="form-control shadow-sm search_booking_from" name="check_in">
                    @error('check_in')
                ...
                <div class="flex-fill">
                    ...
                    <input type="date" class="form-control shadow-sm search_booking_to" name="check_out">
                    @error('check_out')
                        <div class="text-danger small mt-1">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="mb-4">
                ...
                <div class="input-group w-50">
                    ...
                    <input type="text" id="bedrooms" class="form-control text-center search_bedrooms" name="bedrooms" value="0" readonly>
            ...
            <div class="mb-4">
                ...
                <div class="input-group w-50">
                    ...
                    <input type="text" id="adults" class="form-control text-center search_adults" name="adults" value="0" readonly>
            ...
            <div class="mb-4">
                ...
                <div class="input-group w-50">
                    ...
                    <input type="text" id="children" class="form-control text-center search_children" name="children" value="0" readonly>
        ...
        <div class="bg-white p-3 mb-3 rounded-4 border">
            ...
            <div class="d-flex justify-content-between mb-2 text-muted small">
                <span class="stay_duration text-truncate">Stay Duration (1 {{ $property->pricings->isNotEmpty() ? optional($property->pricings->first())->pricing_type : 'N/A' }})</span>
                <span class="stay_amount">₹{{ $property->pricings->isNotEmpty() ? optional($property->pricings->first())->pricing : 'N/A' }}</span>
            </div>
            <div class="d-flex justify-content-between mb-2 text-muted small">
                <span>Tax fee</span>
                <span class="tax_fee">₹{{ $property->pricings->isNotEmpty() ? optional($property->pricings->first())->tax : 'N/A' }}</span>
            </div>
            <div class="d-flex justify-content-between mb-2 text-muted small">
                <span>Coupon Discount</span>
                <span class="coupon_discount text-danger">₹0</span>
            </div>
            <hr>
            <div class="d-flex justify-content-between fw-semibold">
                <span>Total price</span>
                <span class="total_amount">₹{{ $property->pricings->isNotEmpty() ? optional($property->pricings->first())->total : 'N/A' }}</span>
            </div>
        </div>
        ...
        <!-- Make Payment Button -->
        <div class="d-grid">
            <button class="btn btn-danger btn-lg fw-semibold rounded-pill">
                Make Payment
            </button>
        </div>
    </form>
